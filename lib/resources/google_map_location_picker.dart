...
import 'package:crime_alert/model/auto_comp_iete_item.dart';
import 'package:crime_alert/model/location_result.dart';
import 'package:crime_alert/model/nearby_place.dart';
import 'package:crime_alert/resources/rich_suggestions.dart';
import 'package:crime_alert/utils/location.dart';
import 'package:crime_alert/utils/uuid.dart';
...
class LocationPickerState extends State<LocationPicker> {
  ...
  void displayAutoCompleteSuggestions(List<RichSuggestion> suggestions) {
    ...
    var appBarBox = appBarKey.currentContext!.findRenderObject() as RenderBox;
...
//          responseJson['results'][0]['address_components'][1]['short_name'];
      ...
      setState(() {
        locationResult = LocationResult(address: road, latLng: latLng, placeId: placeId);
      });
    }
  }
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: SearchInput(
              ...
              hintText: widget.hintText ?? 'Search location', searchInputKey: UniqueKey(),
            ),
          ),
          body: MapPicker(
            widget.apiKey!,
            ...
            searchBarBoxDecoration: widget.searchBarBoxDecoration ?? BoxDecoration(),
            hintText: widget.hintText ?? 'Pick Location',
            resultCardConfirmIcon: widget.resultCardConfirmIcon ?? Container(),
            resultCardAlignment: widget.resultCardAlignment ?? Alignment(0, 0),
            resultCardDecoration: widget.resultCardDecoration ?? BoxDecoration(),
            resultCardPadding: widget.resultCardPadding ?? EdgeInsets.all(0),
            key: mapKey,
            language: widget.language!,
