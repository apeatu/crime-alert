...
import 'package:crime_alert/utils/future_loading_builder.dart';
import 'package:crime_alert/utils/location.dart';
import 'package:crime_alert/utils/log.dart';
...
class MapPickerState extends State<MapPicker> {
  ...
  final _geolocatorPlatformInterface = GeolocatorPlatform.instance;
  ...
  Future<void> _initCurrentLocation() async {
    ...
    try {
      currentPosition =
          await _geolocatorPlatformInterface.getCurrentPosition(desiredAccuracy: widget.desiredAccuracy!);
...
//            },
                ...
                children: <Widget>[
                  Flexible(
                    ...
                    child: FutureLoadingBuilder<Map<String, String>>(
                      future: getAddress(locationProvider.lastIdleLocation ?? LatLng(_currentPosition!.latitude, _currentPosition!.longitude)),
                      mutable: true,
  ...
  Future _checkGeolocationPermission() async {
    final geolocationStatus = await _geolocatorPlatformInterface.checkPermission();
          ...
          child: AlertDialog(
            ...
            actions: <Widget>[
              TextButton(
                onPressed: () {
                  Navigator.of(context, rootNavigator: true).pop();
                  _geolocatorPlatformInterface.openAppSettings();
                  dialogOpen = null;
                },
                child: Text('Ok'),
              ),
